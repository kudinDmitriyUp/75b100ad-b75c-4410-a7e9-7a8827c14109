...
export const metadata: Metadata = {
  title: "Valerio Noya - Student Athlete Portfolio",
  description: "Portfolio of Valerio Noya, junior at Torrey Pines High School, water polo athlete and academic achiever from Brazil, Italy, now in San Diego.",
  keywords: "Valerio Noya, student athlete, water polo, Torrey Pines High School, San Diego, academic excellence, sports leadership",
  metadataBase: new URL("https://valerionoya.com"),
  alternates: {
    canonical: "https://valerionoya.com"
  },
  openGraph: {
    title: "Valerio Noya - Student Athlete Portfolio",
    description: "Portfolio of Valerio Noya, junior at Torrey Pines High School, water polo athlete and academic achiever from Brazil, Italy, now in San Diego.",
    siteName: "Valerio Noya Portfolio",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763224858449-zgwqvk0c.jpg",
      alt: "Valerio Noya water polo athlete"
    }]
  },
  twitter: {
    ...
    title: "Valerio Noya - Student Athlete Portfolio",
    description: "Portfolio of Valerio Noya, junior at Torrey Pines High School, water polo athlete and academic achiever from Brazil, Italy, now in San Diego.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763224858449-zgwqvk0c.jpg"]
  },
  robots: {
    index: true,
    follow: true
